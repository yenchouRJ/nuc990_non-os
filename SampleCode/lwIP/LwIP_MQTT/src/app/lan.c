...
//static const _S_MQTT_COMMON mc = {1883, "mqtt.flespi.io", 0, "FlespiToken QILc0P0LwrdSmJvZl2SXBaWXlzFrczlS8XSWAGyWVzE780WhQD4gDO3Mby1dVdTR", 0};
static const _S_MQTT_COMMON mc = {8883, "mqtt.flespi.io", 1, "FlespiToken b6CWZ0qr4eT1e3yzZhjGABk2viM8H2eOa0amVxGtDFFeBiFdpZtXvgVyqoDKbcxV", 0};
static void __mqtt_test(void * pv)
{
    ...
    if(subs_cinfo)
    {
        ...
        //mqtt_client_subscribe(subs_cinfo, "nishant/subs/test", 2, __subscribe_upcall);
        mqtt_client_subscribe(subs_cinfo, "start/mqtt", 2, __subscribe_upcall);
    }
    do
    {
...
void mqtt_test_init(void)
{
    xTaskCreate(__mqtt_test, "MQTT TLS", 1024, NULL, 2, &subs_tsk_handle);//stack size is 1000*4 at least
}
