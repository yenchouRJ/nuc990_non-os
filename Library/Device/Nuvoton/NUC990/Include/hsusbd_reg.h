 ...
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[0]     |BUFFULLIF |Buffer Full Interrupt
 ...
 * |[1]     |BUFEMPTYIF|Buffer Empty Interrupt
 ...
 * |        |          |Note: Write 1 to clear this bit to 0.
 * |[8]     |NAKIF     |USB NAK Sent Interrupt
 ...
 * |        |          |Note: Write 1 to clear this bit to 0.
 * |[9]     |STALLIF   |USB STALL Sent Interrupt
 ...
 * |        |          |Note: Write 1 to clear this bit to 0.
 * |[11]    |ERRIF     |ERR Sent Interrupt
 * |        |          |0 = No any error in the transaction.
 * |        |          |1 = There occurs any error in the transaction.
 * |        |          |Note: Write 1 to clear this bit to 0.
 * |[12]    |SHORTRXIF |Bulk Out Short Packet Received Interrupt
 ...
 * Offset: 0x08  Endpoint n Interrupt Enable Control Register
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[0]     |BUFFULLIEN|Buffer Full Interrupt Enable Bit
 ...
 * |[1]     |BUFEMPTYIEN|Buffer Empty Interrupt Enable Bit
 ...
 * |[10]    |NYETIEN   |NYET Sent Interrupt Enable Bit
 ...
 * |[11]    |ERRIEN    |ERR Sent Interrupt Enable Bit
 ...
 * |[12]    |SHORTRXIEN|Bulk Out Short Packet Received Interrupt Enable Bit
 ...
 * |        |          |For an OUT endpoint (EPDIR (HSUSBD_EPxCFG[3] is low.), this register returns the number of received valid bytes in the Host OUT transfer.
 ...
 * |        |          |This bit should always be written after a configuration event.
 ...
 * |        |          |The local CPU may use this bit to initialize the endpointu2019s toggle in case of reception of a Set Interface request or a Clear Feature (ep_halt) request from the host
 * |        |          |Only when toggle bit is u201C1u201D, this bit can be written into the inversed write data bit[3].
 ...
 * |        |          |When an Endpoint Set Feature (ep_halt) is detected by the local CPU, it must write a u20181u2019 to this bit.
 ...
 * |        |          |The received packet size is reference HSUSBD_EPxDATCNT register.
 ...
 * |[9:8]   |MTRANS    |Multi-transfer Configuration
 * |        |          |This filed select how many transfer in a single macro-frame.
 * @var HSUSBD_EP_T::EPBUFSTART
 * Offset: 0x20  Endpoint n RAM Start Address Register
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[12:0]  |SADDR     |Endpoint Start Address
 ...
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[12:0]  |EADDR     |Endpoint End Address
 ...
 */
    ...
    __IO uint32_t EPINTSTS;             /*!< [0x0004] Endpoint A Interrupt Status Register                             */
    __IO uint32_t EPINTEN;              /*!< [0x0008] Endpoint A Interrupt Enable Control Register                     */
    __I  uint32_t EPDATCNT;             /*!< [0x000C] Endpoint A Data Available Count Register                         */
    __IO uint32_t EPRSPCTL;             /*!< [0x0010] Endpoint A Response Control Register                             */
    __IO uint32_t EPMPS;                /*!< [0x0014] Endpoint A Maximum Packet Size Register                          */
    __IO uint32_t EPTXCNT;              /*!< [0x0018] Endpoint A Transfer Count Register                               */
    __IO uint32_t EPCFG;                /*!< [0x001C] Endpoint A Configuration Register                                */
    __IO uint32_t EPBUFSTART;           /*!< [0x0020] Endpoint A RAM Start Address Register                            */
    __IO uint32_t EPBUFEND;             /*!< [0x0024] Endpoint A RAM End Address Register                              */
 ...
 * |        |          |When set, Control-epu2019s interrupt status register should be read to determine the cause of the interrupt.
 * |        |          |0 = No interrupt event occurred.
 * |        |          |1 = The related interrupt event occurred.
 ...
 * |        |          |When set, the corresponding Endpoint Hu2019s interrupt status register should be read to determine the cause of the interrupt.
 * |        |          |0 = No interrupt event occurred.
 * |        |          |1 = The related interrupt event occurred.
 ...
 * |        |          |This bit is set as default and it has to be cleared by writing u20181u2019 before the USB reset
 ...
 * |        |          |Note: Only when CPU writes data[1:0] is 2u2019b10 or 2u2019b00, this bit can be updated.
...
#define HSUSBD_CEPBUFSTART_SADDR_Msk       (0xffful << HSUSBD_CEPBUFSTART_SADDR_Pos)         /*!< HSUSBD_T::CEPBUFSTART: SADDR Mask        */
...
#define HSUSBD_EPRSPCTL_ZEROLEN_Pos        (5)                                               /*!< HSUSBD_T::EPASPCTL: ZEROLEN Position     */
...
#define HSUSBD_EPCFG_MTRANS_Pos            (8)                                               /*!< HSUSBD_T::EPCFG: MTRANS Position         */
#define HSUSBD_EPCFG_MTRANS_Msk            (0x3ul << HSUSBD_EPCFG_MTRANS_Pos)                /*!< HSUSBD_T::EPCFG: MTRANS Mask             */

#define HSUSBD_EPBUFSTART_SADDR_Pos        (0)                                               /*!< HSUSBD_T::EPBUFSTART: SADDR Position     */
#define HSUSBD_EPBUFSTART_SADDR_Msk        (0x1ffful << HSUSBD_EPBUFSTART_SADDR_Pos)         /*!< HSUSBD_T::EPBUFSTART: SADDR Mask         */
