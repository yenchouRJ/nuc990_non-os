...
/**
    @addtogroup HSUSBH USB 2.0 Host Controller
    Memory Mapped Structure for USB 2.0 Host Controller
@{ */
 ...
 * |        |          |The default value of this timer is 12u2019hBD6
 * |        |          |Because this timer is implemented in UTMI clock (30 MHz) domain, the default sleeping time will be about 100us.
 * @var HSUSBH_T::UCFGR
 ...
 * @var HSUSBH_T::UPSCR0
 * Offset: 0x64  USB Port 0 Status and Control Register
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 ...
 * |        |          |Indicates a change has occurred in the portu2019s Current Connect Status
 ...
 * |        |          |For example, the insertion status changes twice before system software has cleared the changed condition, hub hardware will be u201Csettingu201D an already-set bit (i.e., the bit will remain set).Software sets this bit to 0 by writing a 1 to it.
 * |        |          |This field is zero if Port Power is zero.
 * |        |          |0 = No change.
 ...
 * @var HSUSBH_T::UPSCR1
 * Offset: 0x68  USB Port 1 Status and Control Register
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[0]     |CCS       |Current Connect Status (Read Only)
 ...
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[3]     |LPWRMOD   |USB PHY Low Power Mode Enable Bit
 * |        |          |This bit controls the low power mode enable of USB PHY 0.
 * |        |          |0 = USB PHY 0 low power mode Disabled.
 * |        |          |1 = USB PHY 0 low power mode Enabled.
 ...
 * |        |          |This bit is 1u2019b0 by default
 * |        |          |This means the USB PHY 0 is suspended by default
 * |        |          |It is necessary to set this bit 1u2019b1 to make USB PHY 0 leave suspend mode before doing configuration of USB host.
 ...
 * |        |          |SOFTWARE program must prevent to write other control registers before this UTMI clock valid flag is active.
 * |        |          |0 = UTMI clock is not valid.
 * |        |          |1 = UTMI clock is valid.
 * |[12]    |FDISC     |Force Disconnection Function
 * |        |          |This bit is used to force the device to disconnect without really removing the device from the port
 * |        |          |This bit is valid only if FDISCEN is asserted.
 * |        |          |0 = The device is not forced to be disconnected.
 * |        |          |1 = The device is forced to disconnected.
 * |[13]    |FDISCEN   |Force Disconnection Function Enable Bit
 * |        |          |This bit is used to enable Force Disconnection Function (FDISC).
 * |        |          |0 = Force Disconnection Function Disabled.
 * |        |          |1 = Force Disconnection Function Enabled.
...
#define HSUSBH_UPSCR0_PTC_Pos            (16)                                              /*!< HSUSBH_T::UPSCR0: PTC Position         */
#define HSUSBH_UPSCR0_PTC_Msk            (0xful << HSUSBH_UPSCR0_PTC_Pos)                  /*!< HSUSBH_T::UPSCR0: PTC Mask             */

#define HSUSBH_UPSCR1_CCS_Pos            (0)                                               /*!< HSUSBH_T::UPSCR1: CCS Position         */
#define HSUSBH_UPSCR1_CCS_Msk            (0x1ul << HSUSBH_UPSCR1_CCS_Pos)                  /*!< HSUSBH_T::UPSCR1: CCS Mask             */

#define HSUSBH_UPSCR1_CSC_Pos            (1)                                               /*!< HSUSBH_T::UPSCR1: CSC Position         */
#define HSUSBH_UPSCR1_CSC_Msk            (0x1ul << HSUSBH_UPSCR1_CSC_Pos)                  /*!< HSUSBH_T::UPSCR1: CSC Mask             */

#define HSUSBH_UPSCR1_PE_Pos             (2)                                               /*!< HSUSBH_T::UPSCR1: PE Position          */
#define HSUSBH_UPSCR1_PE_Msk             (0x1ul << HSUSBH_UPSCR1_PE_Pos)                   /*!< HSUSBH_T::UPSCR1: PE Mask              */

#define HSUSBH_UPSCR1_PEC_Pos            (3)                                               /*!< HSUSBH_T::UPSCR1: PEC Position         */
#define HSUSBH_UPSCR1_PEC_Msk            (0x1ul << HSUSBH_UPSCR1_PEC_Pos)                  /*!< HSUSBH_T::UPSCR1: PEC Mask             */

#define HSUSBH_UPSCR1_OCA_Pos            (4)                                               /*!< HSUSBH_T::UPSCR1: OCA Position         */
#define HSUSBH_UPSCR1_OCA_Msk            (0x1ul << HSUSBH_UPSCR1_OCA_Pos)                  /*!< HSUSBH_T::UPSCR1: OCA Mask             */

#define HSUSBH_UPSCR1_OCC_Pos            (5)                                               /*!< HSUSBH_T::UPSCR1: OCC Position         */
#define HSUSBH_UPSCR1_OCC_Msk            (0x1ul << HSUSBH_UPSCR1_OCC_Pos)                  /*!< HSUSBH_T::UPSCR1: OCC Mask             */

#define HSUSBH_UPSCR1_FPR_Pos            (6)                                               /*!< HSUSBH_T::UPSCR1: FPR Position         */
#define HSUSBH_UPSCR1_FPR_Msk            (0x1ul << HSUSBH_UPSCR1_FPR_Pos)                  /*!< HSUSBH_T::UPSCR1: FPR Mask             */

#define HSUSBH_UPSCR1_SUSPEND_Pos        (7)                                               /*!< HSUSBH_T::UPSCR1: SUSPEND Position     */
#define HSUSBH_UPSCR1_SUSPEND_Msk        (0x1ul << HSUSBH_UPSCR1_SUSPEND_Pos)              /*!< HSUSBH_T::UPSCR1: SUSPEND Mask         */

#define HSUSBH_UPSCR1_PRST_Pos           (8)                                               /*!< HSUSBH_T::UPSCR1: PRST Position        */
#define HSUSBH_UPSCR1_PRST_Msk           (0x1ul << HSUSBH_UPSCR1_PRST_Pos)                 /*!< HSUSBH_T::UPSCR1: PRST Mask            */

#define HSUSBH_UPSCR1_LSTS_Pos           (10)                                              /*!< HSUSBH_T::UPSCR1: LSTS Position        */
#define HSUSBH_UPSCR1_LSTS_Msk           (0x3ul << HSUSBH_UPSCR1_LSTS_Pos)                 /*!< HSUSBH_T::UPSCR1: LSTS Mask            */

#define HSUSBH_UPSCR1_PP_Pos             (12)                                              /*!< HSUSBH_T::UPSCR1: PP Position          */
#define HSUSBH_UPSCR1_PP_Msk             (0x1ul << HSUSBH_UPSCR1_PP_Pos)                   /*!< HSUSBH_T::UPSCR1: PP Mask              */

#define HSUSBH_UPSCR1_PO_Pos             (13)                                              /*!< HSUSBH_T::UPSCR1: PO Position          */
#define HSUSBH_UPSCR1_PO_Msk             (0x1ul << HSUSBH_UPSCR1_PO_Pos)                   /*!< HSUSBH_T::UPSCR1: PO Mask              */

#define HSUSBH_UPSCR1_PTC_Pos            (16)                                              /*!< HSUSBH_T::UPSCR1: PTC Position         */
#define HSUSBH_UPSCR1_PTC_Msk            (0xful << HSUSBH_UPSCR1_PTC_Pos)                  /*!< HSUSBH_T::UPSCR1: PTC Mask             */

#define HSUSBH_USBPCR0_LPWRMOD_Pos       (3)                                               /*!< HSUSBH_T::USBPCR0: LPWRMOD Position    */
#define HSUSBH_USBPCR0_LPWRMOD_Msk       (0x1ul << HSUSBH_USBPCR0_LPWRMOD_Pos)             /*!< HSUSBH_T::USBPCR0: LPWRMOD Mask        */
...
#define HSUSBH_USBPCR0_FDISC_Pos         (12)                                              /*!< HSUSBH_T::USBPCR0: FDISC Position      */
#define HSUSBH_USBPCR0_FDISC_Msk         (0x1ul << HSUSBH_USBPCR0_FDISC_Pos)               /*!< HSUSBH_T::USBPCR0: FDISC Mask          */

#define HSUSBH_USBPCR0_FDISCEN_Pos       (13)                                              /*!< HSUSBH_T::USBPCR0: FDISCEN Position    */
#define HSUSBH_USBPCR0_FDISCEN_Msk       (0x1ul << HSUSBH_USBPCR0_FDISCEN_Pos)             /*!< HSUSBH_T::USBPCR0: FDISCEN Mask        */
...
#define HSUSBH_USBPCR1_FDISC_Pos         (12)                                              /*!< HSUSBH_T::USBPCR1: FDISC Position      */
#define HSUSBH_USBPCR1_FDISC_Msk         (0x1ul << HSUSBH_USBPCR1_FDISC_Pos)               /*!< HSUSBH_T::USBPCR1: FDISC Mask          */

#define HSUSBH_USBPCR1_FDISCEN_Pos       (13)                                              /*!< HSUSBH_T::USBPCR1: FDISCEN Position    */
#define HSUSBH_USBPCR1_FDISCEN_Msk       (0x1ul << HSUSBH_USBPCR1_FDISCEN_Pos)             /*!< HSUSBH_T::USBPCR1: FDISCEN Mask        */
