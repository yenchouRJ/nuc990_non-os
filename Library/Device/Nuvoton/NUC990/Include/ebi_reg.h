 ...
 * @file     ebi_reg.h
 * @version  V1.00
 * @brief    External Bus Interface(EBI) register definition header file
 *
 ...
 * |        |          |This bit recognizes the EBI_nWAIT signal at the next u201Cnthu201D MCLK rising edge after the EBI_nRD or EBI_nWR active cycle
 * |        |          |WAITVT bits determine the n.
 * |        |          |00 = 1 MCLK cycle.
 * |        |          |01 = 2 MCLK cycle.
 * |        |          |10 = 3 MCLK cycle.
 * |        |          |11 = 4 MCLK cycle.
...
#define EBI_CTL0_WAITVT_Pos              (5)                                               /*!< EBI_T::CTL0: WAITVT Position           */
#define EBI_CTL0_WAITVT_Msk              (0x3ul << EBI_CTL0_WAITVT_Pos)                    /*!< EBI_T::CTL0: WAITVT Mask               */
...
#define EBI_CTL1_WAITVT_Pos              (5)                                               /*!< EBI_T::CTL1: WAITVT Position           */
#define EBI_CTL1_WAITVT_Msk              (0x3ul << EBI_CTL1_WAITVT_Pos)                    /*!< EBI_T::CTL1: WAITVT Mask               */
...
#define EBI_CTL2_WAITVT_Pos              (5)                                               /*!< EBI_T::CTL2: WAITVT Position           */
#define EBI_CTL2_WAITVT_Msk              (0x3ul << EBI_CTL2_WAITVT_Pos)                    /*!< EBI_T::CTL2: WAITVT Mask               */
