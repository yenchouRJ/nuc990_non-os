...
typedef struct
{
     ...
     * |        |          |1 = Capture Function source is from external clock (HXT, LXT).
     ...
     * |        |          |0 = TMx_EXT (x= 0~5) pin, internal clock, or external clock detection Interrupt Disabled.
     * |        |          |1 = TMx_EXT (x= 0~5) pin, internal clock, or external clock detection Interrupt Enabled.
     ...
     * |        |          |For example, while CAPIEN = 1, CAPEN = 1, and CAPEDGE = 00, a 1 to 0 transition on the TMx_EXT (x= 0~5) pin, ACMP, internal clock, or external clock will cause the CAPIF to be set then the interrupt signal is generated and sent to NVIC to inform CPU.
     * |[6]     |CAPDBEN   |Timer External Capture Pin De-bounce Enable Bit
     * |        |          |0 = TMx_EXT (x= 0~5) pin Disabled.
     ...
     * |        |          |000 = Capture event occurred when detect falling edge transfer on TMx_EXT (x= 0~5) pin.
     * |        |          |001 = Capture event occurred when detect rising edge transfer on TMx_EXT (x= 0~5) pin.
     * |        |          |010 = Capture event occurred when detect both falling and rising edge transfer on TMx_EXT (x= 0~5) pin, and first capture event occurred at falling edge transfer.
     * |        |          |011 = Capture event occurred when detect both rising and falling edge transfer on TMx_EXT (x= 0~5) pin, and first capture event occurred at rising edge transfer.
     * |        |          |110 = First capture event occurred at falling edge, follows capture events are at rising edge transfer on TMx_EXT (x= 0~5) pin.
     * |        |          |111 = First capture event occurred at rising edge, follows capture events are at falling edge transfer on TMx_EXT (x= 0~5) pin.
     * |        |          |100, 101 = Reserved.
     ...
     * |        |          |000 = Event Counter input source is from external TMx (x= 0~5) pin.
     * |        |          |001~111 = Reserved.
     ...
     * |        |          |0 = TMx_EXT (x= 0~5) pin, internal clock, or external clock interrupt did not occur.
     * |        |          |1 = TMx_EXT (x= 0~5) pin, internal clock, or external clock interrupt occurred.
     * |        |          |Note 1: This bit is cleared by writing 1 to it.
     * |        |          |Note 2: When CAPEN (TIMERx_EXTCTL[3]) bit is set, CAPFUNCS (TIMERx_EXTCTL[4]) bit is 0, and a transition on TMx_EXT (x= 0~5) pin, internal clock, or external clock matched the CAPEDGE (TIMERx_EXTCTL[2:1]) setting, this bit will set to 1 by hardware.
     ...
     * |        |          |0 = Time-out interrupt signal is used to internal trigger PDMA and ADC.
     * |        |          |1 = Capture interrupt signal is used to internal trigger PDMA and ADC.
     ...
     * |        |          |0 = No effect.
     * |        |          |1 = Write 1 to cClear 16-bit PWM counter to 0x0000 in up count type.
     * |        |          |Note: When user writes this bit to 1, PWM counter will be cleared after (CLKPSC+16) TMRx_CLK cycles.
     ...
     * |        |          |PWM CMP is used to compare with PWM CNT to generate PWM output waveform, interrupt events and trigger ADC PDMA start conversion.
     * @var TIMER_T::PWMCNT
     ...
     */
    __IO uint32_t CTL;     /*!< [0x00] Timer Control Register */
    __IO uint32_t CMP;     /*!< [0x04] Timer Comparator Register */
    __IO uint32_t INTSTS;  /*!< [0x08] Timer Interrupt Status Register */
    __IO uint32_t CNT;     /*!< [0x0C] Timer Data Register */
    __I uint32_t CAP;      /*!< [0x10] Timer Capture Data Register */
    __IO uint32_t EXTCTL;  /*!< [0x14] Timer External Control Register */
    __IO uint32_t EINTSTS; /*!< [0x18] Timer External Interrupt Status Register */
    __IO uint32_t TRGCTL;  /*!< [0x1C] Timer Trigger Control Register */
    __I uint32_t RESERVE0[1];
    __IO uint32_t CAPNF; /*!< [0x24] Timer Capture Input Noise Filter Register */
    __I uint32_t RESERVE1[6];
    __IO uint32_t PWMCTL;     /*!< [0x40] Timer PWM Control Register */
    __IO uint32_t PWMCLKPSC;  /*!< [0x44] Timer PWM Counter Clock Pre-scale Register */
    __IO uint32_t PWMCNTCLR;  /*!< [0x48] Timer PWM Clear Counter Register */
    __IO uint32_t PWMPERIOD;  /*!< [0x4C] Timer PWM Period Register */
    __IO uint32_t PWMCMPDAT;  /*!< [0x50] Timer PWM Comparator Register */
    __I uint32_t PWMCNT;      /*!< [0x54] Timer PWM Counter Register */
    __IO uint32_t PWMPOLCTL;  /*!< [0x58] Timer PWM Pin Output Polar Control Register */
    __IO uint32_t PWMPOCTL;   /*!< [0x5C] Timer PWM Pin Output Control Register */
    __IO uint32_t PWMINTEN0;  /*!< [0x60] Timer PWM Interrupt Enable Register 0 */
    __IO uint32_t PWMINTSTS0; /*!< [0x64] Timer PWM Interrupt Status Register 0 */
    __IO uint32_t PWMTRGCTL;  /*!< [0x68] Timer PWM Trigger Control Register */
    __IO uint32_t PWMSTATUS;  /*!< [0x6C] Timer PWM Status Register */
    __I uint32_t PWMPBUF;     /*!< [0x70] Timer PWM Period Buffer Register */
    __I uint32_t PWMCMPBUF;   /*!< [0x74] Timer PWM Comparator Buffer Register */
    __I uint32_t RESERVE2[12];
    __IO uint32_t PWMIFA;      /*!< [0xA8] Timer PWM Interrupt Flag Accumulator Register          */
    __IO uint32_t PWMAINTSTS;  /*!< [0xAC] Timer PWM Accumulator Interrupt Flag Register          */
    __IO uint32_t PWMAINTEN;   /*!< [0xB0] Timer PWM Accumulator Interrupt Enable Register        */
    __IO uint32_t PWMAPDMACTL; /*!< [0xB4] Timer PWM Accumulator LPPDMA Control Register          */
...
#define TIMER_PWMCTL_CNTEN_Pos           (0)                                               /*!< TMR45_T::PWMCTL: CNTEN Position        */
#define TIMER_PWMCTL_CNTEN_Msk           (0x1ul << TIMER_PWMCTL_CNTEN_Pos)                 /*!< TMR45_T::PWMCTL: CNTEN Mask            */

#define TIMER_PWMCTL_CNTMODE_Pos         (3)                                               /*!< TMR45_T::PWMCTL: CNTMODE Position      */
#define TIMER_PWMCTL_CNTMODE_Msk         (0x1ul << TIMER_PWMCTL_CNTMODE_Pos)               /*!< TMR45_T::PWMCTL: CNTMODE Mask          */

#define TIMER_PWMCTL_DBGHALT_Pos         (30)                                              /*!< TMR45_T::PWMCTL: DBGHALT Position      */
#define TIMER_PWMCTL_DBGHALT_Msk         (0x1ul << TIMER_PWMCTL_DBGHALT_Pos)               /*!< TMR45_T::PWMCTL: DBGHALT Mask          */

#define TIMER_PWMCTL_DBGTRIOFF_Pos       (31)                                              /*!< TMR45_T::PWMCTL: DBGTRIOFF Position    */
#define TIMER_PWMCTL_DBGTRIOFF_Msk       (0x1ul << TIMER_PWMCTL_DBGTRIOFF_Pos)             /*!< TMR45_T::PWMCTL: DBGTRIOFF Mask        */

#define TIMER_PWMCLKPSC_CLKPSC_Pos       (0)                                               /*!< TMR45_T::PWMCLKPSC: CLKPSC Position    */
#define TIMER_PWMCLKPSC_CLKPSC_Msk       (0xfful << TIMER_PWMCLKPSC_CLKPSC_Pos)            /*!< TMR45_T::PWMCLKPSC: CLKPSC Mask        */

#define TIMER_PWMCNTCLR_CNTCLR_Pos       (0)                                               /*!< TMR45_T::PWMCNTCLR: CNTCLR Position    */
#define TIMER_PWMCNTCLR_CNTCLR_Msk       (0x1ul << TIMER_PWMCNTCLR_CNTCLR_Pos)             /*!< TMR45_T::PWMCNTCLR: CNTCLR Mask        */

#define TIMER_PWMPERIOD_PERIOD_Pos       (0)                                               /*!< TMR45_T::PWMPERIOD: PERIOD Position    */
#define TIMER_PWMPERIOD_PERIOD_Msk       (0xfffful << TIMER_PWMPERIOD_PERIOD_Pos)          /*!< TMR45_T::PWMPERIOD: PERIOD Mask        */

#define TIMER_PWMCMPDAT_CMP_Pos          (0)                                               /*!< TMR45_T::PWMCMPDAT: CMP Position       */
#define TIMER_PWMCMPDAT_CMP_Msk          (0xfffful << TIMER_PWMCMPDAT_CMP_Pos)             /*!< TMR45_T::PWMCMPDAT: CMP Mask           */

#define TIMER_PWMCNT_CNT_Pos             (0)                                               /*!< TMR45_T::PWMCNT: CNT Position          */
#define TIMER_PWMCNT_CNT_Msk             (0xfffful << TIMER_PWMCNT_CNT_Pos)                /*!< TMR45_T::PWMCNT: CNT Mask              */

#define TIMER_PWMPOLCTL_PINV_Pos         (0)                                               /*!< TMR45_T::PWMPOLCTL: PINV Position      */
#define TIMER_PWMPOLCTL_PINV_Msk         (0x1ul << TIMER_PWMPOLCTL_PINV_Pos)               /*!< TMR45_T::PWMPOLCTL: PINV Mask          */

#define TIMER_PWMPOCTL_POEN_Pos          (0)                                               /*!< TMR45_T::PWMPOCTL: POEN Position       */
#define TIMER_PWMPOCTL_POEN_Msk          (0x1ul << TIMER_PWMPOCTL_POEN_Pos)                /*!< TMR45_T::PWMPOCTL: POEN Mask           */

#define TIMER_PWMPOCTL_POSEL_Pos         (8)                                               /*!< TMR45_T::PWMPOCTL: POSEL Position      */
#define TIMER_PWMPOCTL_POSEL_Msk         (0x1ul << TIMER_PWMPOCTL_POSEL_Pos)               /*!< TMR45_T::PWMPOCTL: POSEL Mask          */

#define TIMER_PWMINTEN0_PIEN_Pos         (1)                                               /*!< TMR45_T::PWMINTEN0: PIEN Position      */
#define TIMER_PWMINTEN0_PIEN_Msk         (0x1ul << TIMER_PWMINTEN0_PIEN_Pos)               /*!< TMR45_T::PWMINTEN0: PIEN Mask          */

#define TIMER_PWMINTEN0_CMPUIEN_Pos      (2)                                               /*!< TMR45_T::PWMINTEN0: CMPUIEN Position   */
#define TIMER_PWMINTEN0_CMPUIEN_Msk      (0x1ul << TIMER_PWMINTEN0_CMPUIEN_Pos)            /*!< TMR45_T::PWMINTEN0: CMPUIEN Mask       */

#define TIMER_PWMINTSTS0_PIF_Pos         (1)                                               /*!< TMR45_T::PWMINTSTS0: PIF Position      */
#define TIMER_PWMINTSTS0_PIF_Msk         (0x1ul << TIMER_PWMINTSTS0_PIF_Pos)               /*!< TMR45_T::PWMINTSTS0: PIF Mask          */

#define TIMER_PWMINTSTS0_CMPUIF_Pos      (2)                                               /*!< TMR45_T::PWMINTSTS0: CMPUIF Position   */
#define TIMER_PWMINTSTS0_CMPUIF_Msk      (0x1ul << TIMER_PWMINTSTS0_CMPUIF_Pos)            /*!< TMR45_T::PWMINTSTS0: CMPUIF Mask       */

#define TIMER_PWMTRGCTL_TRGSEL_Pos       (0)                                               /*!< TMR45_T::PWMTRGCTL: TRGSEL Position    */
#define TIMER_PWMTRGCTL_TRGSEL_Msk       (0x3ul << TIMER_PWMTRGCTL_TRGSEL_Pos)             /*!< TMR45_T::PWMTRGCTL: TRGSEL Mask        */

#define TIMER_PWMTRGCTL_PWMTRGADC_Pos    (7)                                               /*!< TMR45_T::PWMTRGCTL: PWMTRGADC Position */
#define TIMER_PWMTRGCTL_PWMTRGADC_Msk    (0x1ul << TIMER_PWMTRGCTL_PWMTRGADC_Pos)          /*!< TMR45_T::PWMTRGCTL: PWMTRGADC Mask     */

#define TIMER_PWMTRGCTL_PWMTRGPDMA_Pos   (9)                                               /*!< TMR45_T::PWMTRGCTL: PWMTRGPDMA Position*/
#define TIMER_PWMTRGCTL_PWMTRGPDMA_Msk   (0x1ul << TIMER_PWMTRGCTL_PWMTRGPDMA_Pos)         /*!< TMR45_T::PWMTRGCTL: PWMTRGPDMA Mask    */

#define TIMER_PWMSTATUS_CNTMAXF_Pos      (0)                                               /*!< TMR45_T::PWMSTATUS: CNTMAXF Position   */
#define TIMER_PWMSTATUS_CNTMAXF_Msk      (0x1ul << TIMER_PWMSTATUS_CNTMAXF_Pos)            /*!< TMR45_T::PWMSTATUS: CNTMAXF Mask       */

#define TIMER_PWMSTATUS_ADCTRGF_Pos      (16)                                              /*!< TMR45_T::PWMSTATUS: ADCTRGF Position   */
#define TIMER_PWMSTATUS_ADCTRGF_Msk      (0x1ul << TIMER_PWMSTATUS_ADCTRGF_Pos)            /*!< TMR45_T::PWMSTATUS: ADCTRGF Mask       */

#define TIMER_PWMSTATUS_PDMATRGF_Pos     (18)                                              /*!< TMR45_T::PWMSTATUS: PDMATRGF Position  */
#define TIMER_PWMSTATUS_PDMATRGF_Msk     (0x1ul << TIMER_PWMSTATUS_PDMATRGF_Pos)           /*!< TMR45_T::PWMSTATUS: PDMATRGF Mask      */

#define TIMER_PWMPBUF_PBUF_Pos           (0)                                               /*!< TMR45_T::PWMPBUF: PBUF Position        */
#define TIMER_PWMPBUF_PBUF_Msk           (0xfffful << TIMER_PWMPBUF_PBUF_Pos)              /*!< TMR45_T::PWMPBUF: PBUF Mask            */

#define TIMER_PWMCMPBUF_CMPBUF_Pos       (0)                                               /*!< TMR45_T::PWMCMPBUF: CMPBUF Position    */
#define TIMER_PWMCMPBUF_CMPBUF_Msk       (0xfffful << TIMER_PWMCMPBUF_CMPBUF_Pos)          /*!< TMR45_T::PWMCMPBUF: CMPBUF Mask        */

#define TIMER_PWMIFA_IFACNT_Pos          (0)                                               /*!< TMR45_T::PWMIFA: IFACNT Position       */
#define TIMER_PWMIFA_IFACNT_Msk          (0xfffful << TIMER_PWMIFA_IFACNT_Pos)             /*!< TMR45_T::PWMIFA: IFACNT Mask           */

#define TIMER_PWMIFA_STPMOD_Pos          (24)                                              /*!< TMR45_T::PWMIFA: STPMOD Position       */
#define TIMER_PWMIFA_STPMOD_Msk          (0x1ul << TIMER_PWMIFA_STPMOD_Pos)                /*!< TMR45_T::PWMIFA: STPMOD Mask           */

#define TIMER_PWMIFA_IFASEL_Pos          (28)                                              /*!< TMR45_T::PWMIFA: IFASEL Position       */
#define TIMER_PWMIFA_IFASEL_Msk          (0x3ul << TIMER_PWMIFA_IFASEL_Pos)                /*!< TMR45_T::PWMIFA: IFASEL Mask           */

#define TIMER_PWMIFA_IFAEN_Pos           (31)                                              /*!< TMR45_T::PWMIFA: IFAEN Position        */
#define TIMER_PWMIFA_IFAEN_Msk           (0x1ul << TIMER_PWMIFA_IFAEN_Pos)                 /*!< TMR45_T::PWMIFA: IFAEN Mask            */

#define TIMER_PWMAINTSTS_IFAIF_Pos       (0)                                               /*!< TMR45_T::PWMAINTSTS: IFAIF Position    */
#define TIMER_PWMAINTSTS_IFAIF_Msk       (0x1ul << TIMER_PWMAINTSTS_IFAIF_Pos)             /*!< TMR45_T::PWMAINTSTS: IFAIF Mask        */

#define TIMER_PWMAINTEN_IFAIEN_Pos       (0)                                               /*!< TMR45_T::PWMAINTEN: IFAIEN Position    */
#define TIMER_PWMAINTEN_IFAIEN_Msk       (0x1ul << TIMER_PWMAINTEN_IFAIEN_Pos)             /*!< TMR45_T::PWMAINTEN: IFAIEN Mask        */

#define TIMER_PWMAPDMACTL_APDMAEN_Pos    (0)                                               /*!< TMR45_T::PWMAPDMACTL: APDMAEN Position */
#define TIMER_PWMAPDMACTL_APDMAEN_Msk    (0x1ul << TIMER_PWMAPDMACTL_APDMAEN_Pos)          /*!< TMR45_T::PWMAPDMACTL: APDMAEN Mask     */
