...
/*---------------------- USB Host Controller -------------------------*/
/**
    @addtogroup USBH USB Host Controller
 ...
 * |        |          |0 = The content of HcRhStatus and the content of HcRhPortStatus1 register didnu2019t change.
 ...
 * @var USBH_T::HcRhPortStatus0
 * Offset: 0x54  Host Controller Root Hub Port Status [0]
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[0]     |CCS       |CurrentConnectStatus or ClearPortEnable Bit
 * |        |          |Write Operation:
 * |        |          |0 = No effect.
 * |        |          |1 = Clear port enable.
 * |        |          |Read Operation:
 ...
 * |        |          |Write 1 to clear this bit to zero.
 * |        |          |0 = No connect/disconnect event (CCS (HcRhPortStatus1[0]) didnu2019t change).
 ...
 * |        |          |Write 1 to clear this bit to zero.
 * |        |          |0 = PES (HcRhPortStatus1[1]) didnu2019t change.
 ...
 * |        |          |Write 1 to clear this bit to zero.
 * |        |          |0 = POCI (HcRhPortStatus1[3]) didnu2019t change.
 ...
 * Offset: 0x58  Host Controller Root Hub Port Status [1]
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[0]     |CCS       |CurrentConnectStatus or ClearPortEnable Bit
...
#define USBH_HcRhPortStatus0_CCS_Pos     (0)                                               /*!< USBH_T::HcRhPortStatus0: CCS Position  */
#define USBH_HcRhPortStatus0_CCS_Msk     (0x1ul << USBH_HcRhPortStatus0_CCS_Pos)           /*!< USBH_T::HcRhPortStatus0: CCS Mask      */

#define USBH_HcRhPortStatus0_PES_Pos     (1)                                               /*!< USBH_T::HcRhPortStatus0: PES Position  */
#define USBH_HcRhPortStatus0_PES_Msk     (0x1ul << USBH_HcRhPortStatus0_PES_Pos)           /*!< USBH_T::HcRhPortStatus0: PES Mask      */

#define USBH_HcRhPortStatus0_PSS_Pos     (2)                                               /*!< USBH_T::HcRhPortStatus0: PSS Position  */
#define USBH_HcRhPortStatus0_PSS_Msk     (0x1ul << USBH_HcRhPortStatus0_PSS_Pos)           /*!< USBH_T::HcRhPortStatus0: PSS Mask      */

#define USBH_HcRhPortStatus0_POCI_Pos    (3)                                               /*!< USBH_T::HcRhPortStatus0: POCI Position */
#define USBH_HcRhPortStatus0_POCI_Msk    (0x1ul << USBH_HcRhPortStatus0_POCI_Pos)          /*!< USBH_T::HcRhPortStatus0: POCI Mask     */

#define USBH_HcRhPortStatus0_PRS_Pos     (4)                                               /*!< USBH_T::HcRhPortStatus0: PRS Position  */
#define USBH_HcRhPortStatus0_PRS_Msk     (0x1ul << USBH_HcRhPortStatus0_PRS_Pos)           /*!< USBH_T::HcRhPortStatus0: PRS Mask      */

#define USBH_HcRhPortStatus0_PPS_Pos     (8)                                               /*!< USBH_T::HcRhPortStatus0: PPS Position  */
#define USBH_HcRhPortStatus0_PPS_Msk     (0x1ul << USBH_HcRhPortStatus0_PPS_Pos)           /*!< USBH_T::HcRhPortStatus0: PPS Mask      */

#define USBH_HcRhPortStatus0_LSDA_Pos    (9)                                               /*!< USBH_T::HcRhPortStatus0: LSDA Position */
#define USBH_HcRhPortStatus0_LSDA_Msk    (0x1ul << USBH_HcRhPortStatus0_LSDA_Pos)          /*!< USBH_T::HcRhPortStatus0: LSDA Mask     */

#define USBH_HcRhPortStatus0_CSC_Pos     (16)                                              /*!< USBH_T::HcRhPortStatus0: CSC Position  */
#define USBH_HcRhPortStatus0_CSC_Msk     (0x1ul << USBH_HcRhPortStatus0_CSC_Pos)           /*!< USBH_T::HcRhPortStatus0: CSC Mask      */

#define USBH_HcRhPortStatus0_PESC_Pos    (17)                                              /*!< USBH_T::HcRhPortStatus0: PESC Position */
#define USBH_HcRhPortStatus0_PESC_Msk    (0x1ul << USBH_HcRhPortStatus0_PESC_Pos)          /*!< USBH_T::HcRhPortStatus0: PESC Mask     */

#define USBH_HcRhPortStatus0_PSSC_Pos    (18)                                              /*!< USBH_T::HcRhPortStatus0: PSSC Position */
#define USBH_HcRhPortStatus0_PSSC_Msk    (0x1ul << USBH_HcRhPortStatus0_PSSC_Pos)          /*!< USBH_T::HcRhPortStatus0: PSSC Mask     */

#define USBH_HcRhPortStatus0_OCIC_Pos    (19)                                              /*!< USBH_T::HcRhPortStatus0: OCIC Position */
#define USBH_HcRhPortStatus0_OCIC_Msk    (0x1ul << USBH_HcRhPortStatus0_OCIC_Pos)          /*!< USBH_T::HcRhPortStatus0: OCIC Mask     */

#define USBH_HcRhPortStatus0_PRSC_Pos    (20)                                              /*!< USBH_T::HcRhPortStatus0: PRSC Position */
#define USBH_HcRhPortStatus0_PRSC_Msk    (0x1ul << USBH_HcRhPortStatus0_PRSC_Pos)          /*!< USBH_T::HcRhPortStatus0: PRSC Mask     */
