 ...
 * |        |          |When AA =1 prior to address or data is received, an acknowledged (low level to SDA) will be returned during the acknowledge clock pulse on the SCL line when 1.)
 ...
 * | :----: | :----:   | :---- |
 * |[31:0]  |DAT       |I2C Data
 * |        |          |Bits [7:0]: 8-bit data transferred or received via the I&sup2;C serial port.
 * |        |          |Bits [31:8]: Used in FIFO Mode for additional data storage.
 * @var I2C_T::STATUS0
 ...
 * |        |          |Note: This bit only worked when I2C_TOCTL[3] is set to 0.
 ...
 * |        |          |1= I2C donu2019t hold bus after wake-up.
 ...
 * |        |          |The STO bit shall be set after the 3rd datau2019s SI event being clear
 ...
 * |        |          |0 = I&sup2;C use original pin configuration.
 * |        |          |1 = I&sup2;C switch SCL and SDA pin configuration.
 * |        |          |Note: Original pin configuration table is shown in Pin Configuration chapter.
 * |[12]    |STOPIEN   |Stop Interrupt Enable
 * |        |          |0 = No effect
 * |        |          |1 = It only issue IRQ Handler when STOP happenes.
 ...
 * |        |          |Note: It only works when TWOBUFEN = 1.
 * |[24]    |FIFOEN    |FIFO Enable
 * |        |          |0 = No effect
 * |        |          |1 = Enable TX/RX FIFO.
 * |[25]    |FIFORST   |FIFO Reset
 * |        |          |0 = No effect
 * |        |          |1 = Reset all TX and RX FIFO.
 * |        |          |Note: It only works when FIFOEN = 1.
 * |[29:28] |FIFOTHRES |FIFO Depth Threshold
 * |        |          |For TX mode,an IRQ will be triggered when the TXFCNT = (4 - FIFOTHRES) bytes.
 * |        |          |For RX mode, an IRQ will be triggered when the RXFCNT = (4 + FIFOTHRES) bytes.
 * |        |          |Note: It only works when FIFOEN = 1.
 * @var I2C_T::STATUS1
 ...
 * |        |          |1 = The bus is busy.
 * |[12]    |STOPF     |STOP Detect Flag
 * |        |          |This bit is set by hardware when I2C detect STOP conditiion in both Master and Slave Mode.
 * |        |          |This bit is cleared by writing 1 to it.
 * |        |          |Note: STOPIEN(I2Cn_CTL1[12]) need to be set.
 * |[16]    |TXFIFOUN  |TX FIFO Underflow
 * |        |          |Set when transmitting data and the TX FIFO is empty.
 * |        |          |Cleared by writing 1 to this bit
 * |[17]    |RXFIFOOV  |RX FIFO Overflow
 * |        |          |Set when receiving data and the RX FIFO count exceeds 8 bytes.
 * |        |          |Cleared by writing 1 to this bit.
 ...
 * |        |          |When the address 0u2019b1100001x comes and either BMDEN or ACKMEN is disabled, the device responses NACK.
 * |        |          |1 = Device default address Enabled
 * |        |          |When the address 0u2019b1100001x comes and both BMDEN and ACKMEN are enabled, the device responses ACK.
 ...
 * |        |          |0 = PEC calculation is cleared by u201CRepeat Startu201D function Disabled.
 * |        |          |1 = PEC calculation is cleared by u201CRepeat Startu201D function Enabled.
 ...
 * |        |          |1 = PEC value doesnu2019t match the receive PEC data packet.
 * |        |          |Note: Software can write 1 to clear this bit.
 ...
 */
    ...
    __IO uint32_t STATUS0;        /*!< [0x000C] I2C Status Register 0                                            */
    ...
    __IO uint32_t PKTCRC;         /*!< [0x0060] I2C Packet Error Checking Byte Value Register                    */
...
#define I2C_DAT_DAT_Msk                  (0xfffffffful << I2C_DAT_DAT_Pos)                 /*!< I2C_T::DAT: DAT Mask                   */
...
#define I2C_CTL1_STOPIEN_Pos             (12)                                              /*!< I2C_T::CTL1: STOPIEN Position          */
#define I2C_CTL1_STOPIEN_Msk             (0x1ul << I2C_CTL1_STOPIEN_Pos)                   /*!< I2C_T::CTL1: STOPIEN Mask              */
...
#define I2C_CTL1_FIFOEN_Pos              (24)                                              /*!< I2C_T::CTL1: FIFOEN Position           */
#define I2C_CTL1_FIFOEN_Msk              (0x1ul << I2C_CTL1_FIFOEN_Pos)                    /*!< I2C_T::CTL1: FIFOEN Mask               */

#define I2C_CTL1_FIFORST_Pos             (25)                                              /*!< I2C_T::CTL1: FIFORST Position          */
#define I2C_CTL1_FIFORST_Msk             (0x1ul << I2C_CTL1_FIFORST_Pos)                   /*!< I2C_T::CTL1: FIFORST Mask              */

#define I2C_CTL1_FIFOTHRES_Pos           (28)                                              /*!< I2C_T::CTL1: FIFOTHRES Position        */
#define I2C_CTL1_FIFOTHRES_Msk           (0x3ul << I2C_CTL1_FIFOTHRES_Pos)                 /*!< I2C_T::CTL1: FIFOTHRES Mask            */
...
#define I2C_STATUS1_STOPF_Pos            (12)                                              /*!< I2C_T::STATUS1: STOPF Position         */
#define I2C_STATUS1_STOPF_Msk            (0x1ul << I2C_STATUS1_STOPF_Pos)                  /*!< I2C_T::STATUS1: STOPF Mask             */

#define I2C_STATUS1_TXFIFOUN_Pos         (16)                                              /*!< I2C_T::STATUS1: TXFIFOUN Position      */
#define I2C_STATUS1_TXFIFOUN_Msk         (0x1ul << I2C_STATUS1_TXFIFOUN_Pos)               /*!< I2C_T::STATUS1: TXFIFOUN Mask          */

#define I2C_STATUS1_RXFIFOOV_Pos         (17)                                              /*!< I2C_T::STATUS1: RXFIFOOV Position      */
#define I2C_STATUS1_RXFIFOOV_Msk         (0x1ul << I2C_STATUS1_RXFIFOOV_Pos)               /*!< I2C_T::STATUS1: RXFIFOOV Mask          */
...
#define I2C_STATUS1_TXFCNT_Pos           (24)                                              /*!< I2C_T::STATUS1: TXFCNT Position        */
#define I2C_STATUS1_TXFCNT_Msk           (0xful << I2C_STATUS1_TXFCNT_Pos)                 /*!< I2C_T::STATUS1: TXFCNT Mask            */

#define I2C_STATUS1_RXFCNT_Pos           (28)                                              /*!< I2C_T::STATUS1: RXFCNT Position        */
#define I2C_STATUS1_RXFCNT_Msk           (0x7ul << I2C_STATUS1_RXFCNT_Pos)                 /*!< I2C_T::STATUS1: RXFCNT Mask            */
