...
/**
 * @var CAN_T::CON
 * Offset: 0x00  CAN Control Register
 * ---------------------------------------------------------------------------------------------------
 ...
 * |        |          |1 = Test Mode.
 * @var CAN_T::STATUS
 * Offset: 0x04  CAN Status Register
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[2:0]   |LEC       |Last Error Code
 * |        |          |The LEC field holds a code, which indicates the type of the last error to occur on the CAN bus
 * |        |          |This field will be cleared to u20180u2019 when a message has been transferred (reception or transmission) without error
 * |        |          |The unused code u20187u2019 may be written by the CPU to check for updates
 * |        |          |Table 1.1-4 Last Error Codedescribes the error code.
 * |        |          |Note: Type of the Last Error to Occur on the CAN Bus.
 ...
 * @var CAN_T::ERR
 * Offset: 0x08  CAN Error Counter Register
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 ...
 * |        |          |Valid values for the Baud Rate Prescaler are [0u202663]
 ...
 * |        |          |0x0-0x3: Valid programmed values are [0u20263]
 * |        |          |The actual interpretation by the hardware of this value is such that one more than the value programmed here is used.
 * |        |          |Note: It also means re-synchronization jump width.
 * |[11:8]  |TSeg1     |Time Segment Before the Sample Point Minus Sync_Seg
 * |        |          |0x01-0x0F: valid values for TSeg1 are [1u202615]
 ...
 * |        |          |0x0-0x7: Valid values for TSeg2 are [0u20267]
 * |        |          |The actual interpretation by the hardware of this value is such that one more than the value programmed here is used.
 * @var CAN_T::IIDR
 ...
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[15:0]  |IntId     |Interrupt Identifier
 ...
 * |        |          |Among the message interrupts, the Message Objectu2019 s interrupt priority decreases with increasing message number.
 * |        |          |A message interrupt is cleared by clearing the Message Objectu2019s IntPnd bit (CAN_IFn_MCON[13])
 ...
 * |        |          |10 = CAN_TX pin drives a dominant (u20180u2019) value.
 * |        |          |11 = CAN_TX pin drives a recessive (u20181u2019) value.
 * |[7]     |Rx        |Monitors the Actual Value of CAN_RX Pin (Read Only)
 * |        |          |0 = The CAN bus is dominant (CAN_RX = u20180u2019).
 * |        |          |1 = The CAN bus is recessive (CAN_RX = u20181u2019).
 * |        |          |Note: Reset value: 0000 0000 R000 0000 b (R:current value of RX pin)
 * @var CAN_T::BRPE
 ...
 * @var CAN_T::IF0_CREQ
 * Offset: 0x20  IFn Command Request Registers
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 ...
 * @var CAN_T::IF0_CMASK
 * Offset: 0x24  IFn Command Mask Registers
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 ...
 * @var CAN_T::IF0_MASK1
 * Offset: 0x28  IFn Mask 1 Registers
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 ...
 * @var CAN_T::IF0_MASK2
 * Offset: 0x2C  IFn Mask 2 Registers
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 ...
 * |        |          |Note: When 11-bit (u201Cstandardu201D) Identifiers are used for a Message Object, the identifiers of received Data Frames are written into bits ID28 to ID18 (CAN_IFn_ARB2[12:2])
 * |        |          |For acceptance filtering, only these bits together with mask bits Msk28 to Msk18 (CAN_IFn_MASK2[12:2]) are considered.
 * @var CAN_T::IF0_ARB1
 * Offset: 0x30  IFn Arbitration 1 Registers
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[15:0]  |ID        |Message Identifier 15-0
 * |        |          |ID28 - ID0, 29-bit Identifier (u201CExtended Frameu201D).
 * |        |          |ID28 - ID18, 11-bit Identifier (u201CStandard Frameu201D) 
 * @var CAN_T::IF0_ARB2
 * Offset: 0x34  IFn Arbitration 2 Registers
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 ...
 * |        |          |0 = The 11-bit (u201Cstandardu201D) Identifier will be used for this Message Object.
 * |        |          |1 = The 29-bit (u201Cextendedu201D) Identifier will be used for this Message Object.
 ...
 * @var CAN_T::IF0_MCON
 * Offset: 0x38  IFn Message Control Registers
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 ...
 * |        |          |Note: If the UMask bit is set to one, the Message Objectu2019s mask bits have to be programmed during initialization of the Message Object before MsgVal bit (CAN_IFn_ARB2[15]) is set to one.
 ...
 * |        |          |Note: Only valid for Message Objects with direction = receive.
 * |[15]    |NewDat    |New Data
 ...
 * @var CAN_T::IF0_DAT_A1
 * Offset: 0x3C  IFn Data A1 Registers
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 ...
 * @var CAN_T::IF0_DAT_A2
 * Offset: 0x40  IFn Data A2 Registers
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 ...
 * @var CAN_T::IF0_DAT_B1
 * Offset: 0x44  IFn Data B1 Registers
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 ...
 * @var CAN_T::IF0_DAT_B2
 * Offset: 0x48  IFn Data B2 Registers
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 ...
 * @var CAN_T::IF1_CREQ
 * Offset: 0x80  IFn Command Request Registers
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[5:0]   |MessageNumber|Message Number
 ...
 * |        |          |This bit can only be read by the software.
 * @var CAN_T::IF1_CMASK
 * Offset: 0x84  IFn Command Mask Registers
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[0]     |DAT_B     |Access Data Bytes [7:4]
 ...
 * |        |          |1 = Write: Transfer data from the selected Message Buffer Registers to the Message Object addressed by the Command Request Register.
 * @var CAN_T::IF1_MASK1
 * Offset: 0x88  IFn Mask 1 Registers
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[15:0]  |Msk       |Identifier Mask 15-0
 ...
 * |        |          |1 = The corresponding identifier bit is used for acceptance filtering.
 * @var CAN_T::IF1_MASK2
 * Offset: 0x8C  IFn Mask 2 Registers
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[12:0]  |Msk       |Identifier Mask 28-16
 ...
 * |        |          |For acceptance filtering, only these bits together with mask bits Msk28 to Msk18 (CAN_IFn_MASK2[12:2]) are considered.
 * @var CAN_T::IF1_ARB1
 * Offset: 0x90  IFn Arbitration 1 Registers
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[15:0]  |ID        |Message Identifier 15-0
 ...
 * |        |          |ID28 - ID18, 11-bit Identifier (u201CStandard Frameu201D) 
 * @var CAN_T::IF1_ARB2
 * Offset: 0x94  IFn Arbitration 2 Registers
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[12:0]  |ID        |Message Identifier 28-16
 ...
 * |        |          |This bit must also be reset before the identifier Id28-0 (CAN_IFn_ARB1/2), the control bits Xtd (CAN_IFn_ARB2[14]), Dir (CAN_IFn_ARB2[13]), or the Data Length Code DLC3-0 (CAN_IFn_MCON[3:0]) are modified, or if the Messages Object is no longer required.
 * @var CAN_T::IF1_MCON
 * Offset: 0x98  IFn Message Control Registers
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[3:0]   |DLC       |Data Length Code
 ...
 * |        |          |0 = No new data has been written into the data portion of this Message Object by the Message Handler since last time this flag was cleared by the application software.
 * |        |          |1 = The Message Handler or the application software has written new data into the data portion of this Message Object.
 * @var CAN_T::IF1_DAT_A1
 * Offset: 0x9C  IFn Data A1 Registers
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[7:0]   |Data_0_   |Data Byte 0
 ...
 * |[15:8]  |Data_1_   |Data Byte 1
 * |        |          |2nd data byte of a CAN Data Frame
 * @var CAN_T::IF1_DAT_A2
 * Offset: 0xA0  IFn Data A2 Registers
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[7:0]   |Data_2_   |Data Byte 2
 ...
 * |[15:8]  |Data_3_   |Data Byte 3
 * |        |          |4th data byte of CAN Data Frame
 * @var CAN_T::IF1_DAT_B1
 * Offset: 0xA4  IFn Data B1 Registers
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[7:0]   |Data_4_   |Data Byte 4
 ...
 * |[15:8]  |Data_5_   |Data Byte 5
 * |        |          |6th data byte of CAN Data Frame
 * @var CAN_T::IF1_DAT_B2
 * Offset: 0xA8  IFn Data B2 Registers
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[7:0]   |Data_6_   |Data Byte 6
 ...
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[15:0]  |TxRqst16_1|Transmission Request Bits 16-1 of All Message Objects (Read Only)
 * |        |          |0 = This Message Object is not waiting for transmission.
 * |        |          |1 = The transmission of this Message Object is requested and is not yet done.
 * @var CAN_T::TXREQ2
 ...
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[15:0]  |TxRqst32_17|Transmission Request Bits 32-17 of All Message Objects (Read Only)
 * |        |          |0 = This Message Object is not waiting for transmission.
 * |        |          |1 = The transmission of this Message Object is requested and is not yet done.
 * @var CAN_T::NDAT1
...
typedef struct
{
    ...
    __IO uint32_t ERR;                   /*!< [0x0008] Error Counter Register                                           */
    __IO uint32_t BTIME;                 /*!< [0x000c] Bit Timing Register                                              */
    __IO uint32_t IIDR;                  /*!< [0x0010] Interrupt Identifier Register                                    */
    ...
    __IO uint32_t TXREQ1;                /*!< [0x0100] Transmission Request Register 1                                  */
    __IO uint32_t TXREQ2;                /*!< [0x0104] Transmission Request Register 2                                  */
    __IO uint32_t RESERVE3[6];
    __IO uint32_t NDAT1;                 /*!< [0x0120] New Data Register 1                                              */
    __IO uint32_t NDAT2;                 /*!< [0x0124] New Data Register 2                                              */
    __IO uint32_t RESERVE4[6];
    __IO uint32_t IPND1;                 /*!< [0x0140] Interrupt Pending Register 1                                     */
    __IO uint32_t IPND2;                 /*!< [0x0144] Interrupt Pending Register 2                                     */
    __IO uint32_t RESERVE5[6];
    __IO uint32_t MVLD1;                 /*!< [0x0160] Message Valid Register 1                                         */
    __IO uint32_t MVLD2;                 /*!< [0x0164] Message Valid Register 2                                         */
