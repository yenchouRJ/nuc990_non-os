...
/**
  ...
  * \hideinitializer
  */
#define SCUART_GET_TX_EMPTY(sc) (((sc) == 0) ? (SC0->STATUS & SC_STATUS_TXEMPTY_Msk) : (SC1->STATUS & SC_STATUS_TXEMPTY_Msk))
...
/**
  ...
  * \hideinitializer
  */
#define SCUART_GET_TX_FULL(sc) (((sc) == 0) ? (SC0->STATUS & SC_STATUS_TXFULL_Msk) : (SC1->STATUS & SC_STATUS_TXFULL_Msk))
...
do {\
    if((sc) == 0)\
        while(SC0->STATUS & SC_STATUS_TXACT_Msk);\
    else\
        while(SC1->STATUS & SC_STATUS_TXACT_Msk);\
}while(0)
...
/**
  ...
  * \hideinitializer
  */
#define SCUART_IS_TX_FULL(sc) (((sc) == 0) ? ((SC0->STATUS & SC_STATUS_TXFULL_Msk) ? 1 : 0) : ((SC1->STATUS & SC_STATUS_TXFULL_Msk) ? 1 : 0))
...
/**
  ...
  * \hideinitializer
  */
#define SCUART_IS_TX_EMPTY(sc) (((sc) == 0) ? ((SC0->STATUS & SC_STATUS_TXACT_Msk) ? 1 : 0) : ((SC1->STATUS & SC_STATUS_TXACT_Msk) ? 1 : 0))
...
/**
  ...
  * \hideinitializer
  */
#define SCUART_READ(sc) (((sc) == 0) ? SC0->DAT : SC1->DAT)
...
/**
  ...
  * \hideinitializer
  */
#define SCUART_GET_RX_EMPTY(sc) (((sc) == 0) ? (SC0->STATUS & SC_STATUS_RXEMPTY_Msk) : (SC1->STATUS & SC_STATUS_RXEMPTY_Msk))
...
/**
  ...
  * \hideinitializer
  */
#define SCUART_GET_RX_FULL(sc) (((sc) == 0) ? (SC0->STATUS & SC_STATUS_RXFULL_Msk) : (SC1->STATUS & SC_STATUS_RXFULL_Msk))
...
/**
  ...
  * \hideinitializer
  */
#define SCUART_IS_RX_READY(sc) (((sc) == 0) ? ((SC0->INTSTS & SC_INTSTS_RDAIF_Msk) ? 1 : 0) : ((SC1->INTSTS & SC_INTSTS_RDAIF_Msk) ? 1 : 0))
...
/**
  ...
  * \hideinitializer
  */
#define SCUART_IS_RX_FULL(sc) (((sc) == 0) ? ((SC0->STATUS & SC_STATUS_RXFULL_Msk) ? 1 : 0) : ((SC1->STATUS & SC_STATUS_RXFULL_Msk) ? 1 : 0))
...
/**
  ...
  * @param[in] sc Smartcard module number
  * @param[in] u32Mask Interrupt masks to disable.
  * @return None
  * \hideinitializer
  */
...
/**
  ...
  * \hideinitializer
  */
#define SCUART_GET_INT_FLAG(sc, u32Type) (((sc) == 0) ? ((SC0->INTSTS & (u32Type)) ? 1 : 0) : ((SC1->INTSTS & (u32Type)) ? 1 : 0))
...
/**
  ...
  * \hideinitializer
  */
#define SCUART_GET_ERR_FLAG(sc) (((sc) == 0) ? (SC0->STATUS & (SC_STATUS_PEF_Msk | SC_STATUS_FEF_Msk | SC_STATUS_BEF_Msk)) : (SC1->STATUS & (SC_STATUS_PEF_Msk | SC_STATUS_FEF_Msk | SC_STATUS_BEF_Msk)))
